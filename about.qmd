      ...
      <div class="row align-items-center g-4">
        <div class="col-12 col-lg-7">
          <div class="text-uppercase opacity-75" style="letter-spacing:.08em; font-size:.85rem;">
            climate + people + policy + data = action
          </div>
          <h1 class="display-5 fw-semibold mt-2"> Welcome! I am Nibia </h1>
          <p class="lead mt-3 mb-0">
            I am a B.A. in Biology and Statistics, passionate about environmental justice and building a career in the intersection of science, policy and implementation. I love working with data, researching and people.
  ...
  <div class="container py-5">
    <div class="row align-items-center g-4">
      ...
      <div class="col-12 col-lg-6">
        ...
        <ul class="mt-3">
          <li>[1 concrete responsibility]</li>
          <li>[1 concrete outcome]</li>
          <li>[1 skills signal: coordination / systems / trust]</li>
        </ul>
        <div class="mt-4">
      ...
      <!-- IMAGE OR CAROUSEL -->
      <div class="col-12 col-lg-6">
        <img src="images_about/about_1_Peace_Day_2024.JPG" alt="Highlight 1"
             class="img-fluid shadow"
